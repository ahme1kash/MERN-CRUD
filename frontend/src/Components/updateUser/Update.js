...
const Update = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            let response = await axios.get(`https://mern-crud-backend-black.vercel.app/api/getSingleUser/${id}`)
    ...
    const submitForm = async (e) => {
        try {
            e.preventDefault();
            await axios.put(`https://mern-crud-backend-black.vercel.app/api/updateUser/${id}`, user)
